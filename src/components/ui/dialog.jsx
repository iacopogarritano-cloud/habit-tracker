    ...
    <DialogPortal>
      ...
      >
        ...
        <DialogPrimitive.Close
          ...
          className="absolute top-4 right-4 flex items-center justify-center w-6 h-6 rounded-sm cursor-pointer opacity-60 transition-opacity hover:opacity-100 disabled:pointer-events-none"
        >
